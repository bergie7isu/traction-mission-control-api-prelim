...
VALUES
  ...
  ('Fourth to-do', 'Steve Thor', '2019-04-03', '2019-04-10', null, null, 'no', 4),
  ('Fifth to-do', 'Nathan Witt', '2019-05-03', '2019-05-10', null, null, 'no', 5),
  ('Sixth to-do', 'Mark Bergstrom', '2019-06-03', '2019-06-10', 'Done', '2019-06-10', 'yes', 6),
  ('Seventh to-do', 'Paul Johnson', '2019-07-03', '2019-07-10', 'Not Done', '2019-06-10', 'yes', 7),
  ('Eighth to-do', 'Joel Tjepkes', '2019-08-03', '2019-08-10', 'Done', '2019-06-10', 'yes', 8),
  ('Ninth to-do', 'Steve Thor', '2019-09-03', '2019-09-10', 'Not Done', '2019-06-10', 'yes', 9),
  ('Tenth to-do', 'Nathan Witt', '2019-10-03', '2019-10-10', 'Done', '2019-06-10', 'yes', 10),
  ('Eleventh to-do', 'Mark Bergstrom', '2019-11-03', '2019-11-10', 'Not Done', '2019-06-10', 'yes', 11);
